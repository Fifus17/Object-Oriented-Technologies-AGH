...
public final class SerializablePersistenceManager implements IPersistanceManager {
    ...
    @Inject
    public SerializablePersistenceManager(@Named("teachers")String teachersFile, @Named("classes") String studentsFile) {
        teachersStorageFileName = teachersFile;
        classStorageFileName = studentsFile;
    }
